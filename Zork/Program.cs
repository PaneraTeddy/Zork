...
namespace Zork
{
    class Program
    {
        ...
        private static void InitializeRoomDescriptions()
        {
            ...
            Rooms[0, 1].Description = "You are facing the north side of a white house. There is no door here, and all the windowss are barred.";
            ...
            Rooms[1, 2].Description = "You are behind the white house. In one cornner of the house there is a small window which is slightly ajar";

            Rooms[2, 0].Description = "This is a dimly lit forest, with large trees all around. To the east, there appears to be sunlight.";
            Rooms[2, 1].Description = "You are facing the south side of a white house. There is no door here, and all the windows are barred."; // south
